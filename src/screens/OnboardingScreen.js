...
const LANGS = [
  { code:'nl', flag:'NL' },{ code:'en', flag:'EN' },{ code:'de', flag:'DE' },{ code:'fr', flag:'FR' },
];
const SITUATIONS = [
  { key:'werknemer', label:'Werknemer' },{ key:'zzp', label:"ZZP'er" },
  { key:'student', label:'Student' },{ key:'gepension', label:'Gepensioneerd' },{ key:'anders', label:'Anders' },
];
const STEPS = [
